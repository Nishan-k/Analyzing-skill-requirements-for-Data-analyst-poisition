...
class SchleswigSpider(scrapy.Spider):
    name = 'schleswig'
    allowed_domains = ['de.indeed.com']
    start_urls = ['https://de.indeed.com/jobs?q=data%20analyst&l=Schleswig-Holstein&vjk=1f5eba7de48935a2']
    ...
    def parse(self, response):
        ...
        for page_number in range(0, 100, 10):
            pagination = f"https://de.indeed.com/jobs?q=data%20analyst&l=Schleswig-Holstein&start={page_number}"
