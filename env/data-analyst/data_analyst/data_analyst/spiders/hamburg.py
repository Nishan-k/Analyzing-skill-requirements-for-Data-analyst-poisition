...
class HamburgSpider(scrapy.Spider):
    ...
    start_urls = ['https://de.indeed.com/jobs?q=data%20analyst&l=Hamburg&vjk=ad5bd1fc931c60dc']
    ...
    def parse(self, response):
        ...
        for page_number in range(0, 300, 10):
            pagination = f"https://de.indeed.com/jobs?q=data+analyst&l=Hamburg&start={page_number}"
