...
class BrandenburgSpider(scrapy.Spider):
    ...
    start_urls = ['https://de.indeed.com/jobs?q=data%20analyst&l=Brandenburg&from=searchOnHP&vjk=2b460f01d8a21fb8']
    ...
    def parse(self, response):
        ...
        for page_number in range(0, 40, 10):
            pagination = f"https://de.indeed.com/jobs?q=data%20analyst&l=Brandenburg&start={page_number}"
