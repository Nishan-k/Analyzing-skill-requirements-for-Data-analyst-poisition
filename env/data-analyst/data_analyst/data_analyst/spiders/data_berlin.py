...
class DataBerlinSpider(scrapy.Spider):
    name = 'data_berlin'
    allowed_domains = ['de.indeed.com']
    start_urls = ['https://de.indeed.com/jobs?q=data%20analyst&l=Berlin&vjk=a84c31bb8a84156e']
    ...
    def parse(self, response):
        ...
        for page_number in range(0, 300, 10):
            pagination = f"https://de.indeed.com/jobs?q=data%20analyst&l=Berlin&start={page_number}"
