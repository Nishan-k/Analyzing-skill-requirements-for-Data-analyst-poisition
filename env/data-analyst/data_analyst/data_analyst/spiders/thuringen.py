...
class ThuringenSpider(scrapy.Spider):
    name = 'thuringen'
    allowed_domains = ['de.indeed.com']
    start_urls = ['https://de.indeed.com/jobs?q=data%20analyst&l=Th%C3%BCringen&vjk=2b460f01d8a21fb8']
    ...
    def parse(self, response):
        ...
        for page_number in range(0, 100, 10):
            pagination = f"https://de.indeed.com/jobs?q=data%20analyst&l=Th%C3%BCringen&start={page_number}"
