...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'D:\Data analyst\Projects\9. data about data\env'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'D:\Data analyst\Projects\9. data about data\env\Scripts\deactivate.nu'
